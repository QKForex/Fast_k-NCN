...
//
const Distance Parallel_kNCN::find1NN(const SampleSet& trainSet, const Sample& testSample) {
...
int Parallel_kNCN::assignLabel(const int testSampleIndex) {
